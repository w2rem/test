...
ICON_SAGERNET = '''<svg width="44" height="44" xmlns="http://www.w3.org/2000/svg" viewBox="269 262 486 550">
  <defs>
...
ICON_SVGS = {"python": ICON_PYTHON, "tailscale": ICON_TAILSCALE,
             "postgres": ICON_POSTGRES, "valkey": ICON_VALKEY,
...
WORKER_ENV_KEYS = ("PG_DATABASE_URL", "STREAMLIT_SESSION_TOKEN", "STREAMLIT_SESSION",
                   ...
                   "TS_VERSION", "TS_CLIENT_ID", "TS_CLIENT_SECRET",
                   "TS_TAILNET", "TS_TAGS", "TS_HOSTNAME_BASE", "TS_HOST", "TS_SERVE_PORT",
                   "VALKEY_DATABASE_URL", "VALKEY_ADDR", "VALKEY_USER", "VALKEY_PASSWORD",
                   "VALKEY_DB", "VLK_PING_EVERY",
                   "SINGBOX_VERSION", "SINGBOX_BIN_DIR")
